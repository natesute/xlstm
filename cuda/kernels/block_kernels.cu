...
template __global__ void xlstm_block_backward_kernel<float>(const float *__restrict__ grad_h,
                                                  ...
                                                  float *__restrict__ grad_C_prev,
                                                  float *__restrict__ grad_n_prev,
                                                  float *__restrict__ grad_w_proj,
                                                  float *__restrict__ grad_w_gate,
                                                  float *__restrict__ grad_b_proj,
                                                  float *__restrict__ grad_b_gate,
                                                  float *__restrict__ grad_w_slstm,
                                                  float *__restrict__ grad_w_mlstm,
                                                  float *__restrict__ grad_b_slstm,
                                                  float *__restrict__ grad_b_mlstm,
                                                  int batch_size,
                                                  int input_size,
                                                  int hidden_size,
                                                  int proj_size,
...
template __global__ void xlstm_block_backward_kernel<double>(const double *__restrict__ grad_h,
                                                   ...
                                                   double *__restrict__ grad_h_prev,
                                                   double *__restrict__ grad_c_prev,
                                                   double *__restrict__ grad_C_prev,
                                                   double *__restrict__ grad_n_prev,
                                                   double *__restrict__ grad_w_proj,
                                                   double *__restrict__ grad_w_gate,
                                                   double *__restrict__ grad_b_proj,
                                                   double *__restrict__ grad_b_gate,
                                                   double *__restrict__ grad_w_slstm,
                                                   double *__restrict__ grad_w_mlstm,
                                                   double *__restrict__ grad_b_slstm,
                                                   double *__restrict__ grad_b_mlstm,
                                                   int batch_size,
                                                   int input_size,
                                                   int hidden_size,
                                                   int proj_size,
